...
const DEFAULT_MATERIALS = [
  {
    id: 'mat-1',
    title: 'Paket Evaluasi 30 Soal Ujian Utama (Behavioral AI Telemetry)',
    soalCount: 30,
    totalTime: '60:00',
    createdAt: '4 Aug 2026',
    questions: FULL_30_QUESTIONS
  }
];
...
export default function Home() {
  ...
  const questionsList = isDemo ? DEMO_QUESTIONS : (materials[0]?.questions && materials[0]?.questions.length > 5 ? materials[0].questions : FULL_30_QUESTIONS);
